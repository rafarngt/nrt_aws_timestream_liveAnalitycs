...
# Ruta a la carpeta principal que contiene los archivos Parquet para bcvposlogtransaction
data_folder = 'data_dummy/bcvposlogtransaction'
...
record_type = 'bcvposlogtransaction'
